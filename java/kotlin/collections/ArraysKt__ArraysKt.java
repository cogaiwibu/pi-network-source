                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m520contentEqualslec5QzE(t.m220unboximpl(), t2.m220unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m516contentEqualsKJPZfPQ(t.m150unboximpl(), t2.m150unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m515contentEqualsFGO6Aew(t.m316unboximpl(), t2.m316unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m518contentEqualskV0jMPg(t.m80unboximpl(), t2.m80unboximpl())) {
                                                        return false;
                                                    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    T t2 = t;
                    if (t2 != null) {
                        bArr = t2.m80unboximpl();
                    }
                    sb.append(UArraysKt.m532contentToString2csIQuQ(bArr));
                } else if (t instanceof UShortArray) {
                    T t3 = t;
                    if (t3 != null) {
                        sArr = t3.m316unboximpl();
                    }
                    sb.append(UArraysKt.m536contentToStringd6D3K8(sArr));
                } else if (t instanceof UIntArray) {
                    T t4 = t;
                    if (t4 != null) {
                        iArr = t4.m150unboximpl();
                    }
                    sb.append(UArraysKt.m535contentToStringXUkPCBk(iArr));
                } else if (t instanceof ULongArray) {
                    T t5 = t;
                    if (t5 != null) {
                        jArr = t5.m220unboximpl();
                    }
                    sb.append(UArraysKt.m538contentToStringuLth9ew(jArr));
                } else {
