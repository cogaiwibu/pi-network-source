...
public class E3 extends SX {
    public final /* synthetic */ AbstractC0722Sn A00;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public E3(AbstractC0722Sn sn, Context context) {
        super(context);
        this.A00 = sn;
    }
    ...
    public final void A0J(View view, AnonymousClass4U r6, AnonymousClass4Q r7) {
        AbstractC0722Sn sn = this.A00;
        int[] A0J = sn.A0J(sn.A00.getLayoutManager(), view);
        int i = A0J[0];
        int i2 = A0J[1];
