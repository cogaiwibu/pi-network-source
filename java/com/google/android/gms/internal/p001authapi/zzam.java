...
final class zzam extends Api.AbstractClientBuilder<zzab, zzf> {
    ...
    public final /* synthetic */ zzab buildClient(Context context, Looper looper, ClientSettings clientSettings, zzf zzf, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        return new zzab(context, looper, zzf, clientSettings, connectionCallbacks, onConnectionFailedListener);
    }
}
