    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (response != null) {
            ...
            if (code == 307 || code == 308) {
                if (!method.equals(NativeEventsConstants.HTTP_METHOD_GET) && !method.equals(VersionInfo.GIT_BRANCH)) {
                    return null;
                }
            } else if (code == 401) {
            ...
            if (HttpMethod.permitsRequestBody(method)) {
                ...
                if (HttpMethod.redirectsToGet(method)) {
                    newBuilder.method(NativeEventsConstants.HTTP_METHOD_GET, null);
                } else {
                ...
                if (!redirectsWithBody) {
                    ...
                    newBuilder.removeHeader(Events.CONTENT_TYPE);
                }
            }
